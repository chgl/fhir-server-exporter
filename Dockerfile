...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/dotnet/sdk:10.0.401-resolute@sha256:21f0f95a0bd9a9619e4eff31b32f6b1b292d34e4e502c746ecc5fddfb294d9f1 AS build
WORKDIR "/build"
